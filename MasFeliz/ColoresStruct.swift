...
struct Colores {
    let colores = [
        ...
        UIColor(red: 40/255, green: 190/255, blue: 90/255, alpha: 1),
        UIColor(red: 50/255, green: 190/255, blue: 90/255, alpha: 1),
        UIColor(red: 60/255, green: 190/255, blue: 90/255, alpha: 1),
        UIColor(red: 70/255, green: 190/255, blue: 90/255, alpha: 1),
        UIColor(red: 80/255, green: 190/255, blue: 90/255, alpha: 1),
        UIColor(red: 80/255, green: 190/255, blue: 90/255, alpha: 1),
        UIColor(red: 90/255, green: 190/255, blue: 90/255, alpha: 1),
        UIColor(red: 10/255, green: 190/255, blue: 90/255, alpha: 1)
    ]
...
struct Datos {
    ...
    func RegresaColorAleatorio()->String{
